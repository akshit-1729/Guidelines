...
if __name__ == "__main__":
    ...
    if graph_store.graph.number_of_edges() == 0:
        ...
        with open('Guidelines/Data/NCCN_prostate_4.2024_Graph_12_33.json', 'r') as f:
            data = json.load(f)
    ...
    print("\nAdvanced query results for 'How is bone imaging performed?':")
    advanced_results = graph_store.advanced_query("How is bone imaging performed?")
    ...
    with open("subgraph3.dot", "w") as f:
        f.write(dot_representation)

    print("\nDOT representation has been saved to 'subgraph3.dot'")
